...
'========================================================================
' Module    : mod_Common
' Procedure : GetSIniStr
' @ Author  :
' @ Date    : 2015/8/27
' Purpose   : Get Lexicon of component from database
' Details   : 自Local MDB中取得顯示在畫面上的詞彙
'========================================================================
Function GetSIniStr(ByVal Section$, ByVal Topic$) As String
'
    GetSIniStr = " "
    If Trim(DB_LOCAL.Connect) <> "" Then
        Dim A_Sql$  'SQL Commands String
